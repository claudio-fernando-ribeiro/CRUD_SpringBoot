...
public class VendaController {
    ...
    @Autowired //anotação spring boot para criar referência
    ...
    public ModelAndView save(@Valid Venda venda, BindingResult bindingResult){ //essa anotação só permite dados válidos, ela é realizada em conjunto com a anotação @NotBlank na camada Cliente da entidade. 
        service.save(venda);
